...
export function mapMemberToInsertPayload(
  ...
  return {
    ...
    memIdIssueDate: formatForApi(member.memIdIssueDateAD),
    employeeId: "", // handled by server session
    ...
    householdId,
    headHousehold: member.headHousehold ? "Y" : "",
    ...
    vaccinationStatus: member.minorYn ? (member.vaccinationStatus ?? "N") : "",
...
export function mapMemberToUpdatePayload(
  ...
  return {
    ...mapMemberToInsertPayload(member, householdId, user),

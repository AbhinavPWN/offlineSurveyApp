...
export function mapServerMemberToDb(
  ...
  return {
    ...
    healthConditionsChr: normalizeYN(m.healtH_CONDITION_CHR),
    healthConditionsOth: normalizeYN(m.healtH_CONDITION_OTH),
    healthConditionsOthers: normalizeString(m.healtH_CONDITION_OTHERS),
